...
it("Deberia tener costo de envio 8 para peso entre 101 y 200", () => {
  let totalizador = new Totalizador();

  expect(totalizador.CostoEnvio(200)).toEqual(8);
});

it("Deberia tener costo de envio 9 para peso mayor a 200", () => {
  let totalizador = new Totalizador();

  expect(totalizador.CostoEnvio(201)).toEqual(9);
});
...
it("Deberia aplicar 0% de descuento al envio para cliente Normal", () => {
  let totalizador = new Totalizador();

  expect(
    totalizador.DescuentoEnvioCliente("Normal", 100)
  ).toEqual(0);
});
